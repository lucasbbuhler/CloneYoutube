...
function Home() {
  ...
  const API_KEY = 'AIzaSyDClB2S8ARQ0CXUFiQYpi9BvIZXENOr2-s'

  const url = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet&part=statistics&chart=mostPopular&hl=pt_BR&maxResults=48&regionCode=br&videoCategoryId=26&key=${API_KEY}`
